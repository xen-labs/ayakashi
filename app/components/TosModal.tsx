  ...
  return (
    ...
    >
      ...
      <div className="flex shrink-0 items-center justify-between border-b border-white/10 px-6 py-4">
        <h2
          id="tos-title"
          className="text-lg font-bold uppercase tracking-widest text-ayakashi-gold"
      ...
      <div className="overflow-y-auto px-6 py-6 text-sm leading-7 text-gray-300 space-y-6">
        ...
        <section>
          <h3 className="mb-2 text-base font-semibold uppercase tracking-wider text-ayakashi-gold">
            1. Acceptance of Terms
          </h3>
          <p>
            By creating an account on Ayakashi (&ldquo;the Platform&rdquo;), you
        ...
        <section>
          ...
          <p>
            ...
            registering, you represent that you meet this requirement. Users
        ...
        <section>
          ...
          <p>
            ...
            immediately of any unauthorised access. We are not liable for losses
        ...
        <section>
          ...
          <p>
            Ayakashi operates via a WhatsApp bot. By providing your WhatsApp
            number you consent to receive automated messages from our bot
            account. You may opt out at any time by messaging{" "}
            <span className="text-ayakashi-gold">STOP</span> to the bot.
        ...
        <section>
          ...
          <p>
            Cards, items, and any in-game assets are virtual and have no
            real-world monetary value unless explicitly stated. Auction results
            are final. We reserve the right to revoke items obtained through
            exploits or violations of these terms.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="ml-4 list-disc space-y-1">
            ...
            <li>
              Selling accounts or virtual items for real money outside approved
              channels
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            All content, artwork, and branding on the Platform are the property
            of Ayakashi or its licensors. You may not reproduce or distribute
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            via the WhatsApp bot or support email.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            these terms, with or without prior notice. You may delete your
            account at any time.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            any kind. To the maximum extent permitted by law, Ayakashi shall not
      ...
      <div className="shrink-0 border-t border-white/10 px-6 py-4 flex justify-end">
        <button
          type="button"
          onClick={onClose}
          className="h-10 border border-ayakashi-gold bg-ayakashi-gold px-6 text-sm font-bold uppercase tracking-wider text-black transition-all hover:bg-white"
        >
          I Understand
        </button>
      </div>
