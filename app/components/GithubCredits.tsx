export function GithubCredits() {
  return (
    <div className="github-credits-root mx-auto flex max-w-6xl flex-col items-center gap-2 border-t px-4 py-8 text-center opacity-60 transition-opacity hover:opacity-100">
      <a
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <span className="github-credits-handle">@Aoi-03</span>
        </a>
        <span className="github-credits-dot">·</span>
        <a
        ...
        >
          ...
          <span className="github-credits-handle">@Xenkaii</span>
        </a>
      </div>
    </div>
  );
