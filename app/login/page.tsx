...
export default function Login() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        setLoading(true);
        try {
            // [NEW] Refreshes the account's device fingerprint on every
            // successful login, same reasoning as register_page.tsx's
            // registration-time capture — see login.ts's backend handling for
            // why this refreshes rather than only being set once at signup.
        ...
        <main className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-[#0a0a0a] px-4 py-10 sm:px-6 lg:px-8">
            ...
            <section className="relative z-10 grid w-full max-w-5xl gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
                ...
                <div className="flex flex-col items-center gap-6 text-center lg:items-start lg:text-left">
                    ...
                    >
                        Sign in to access your card collection, live auctions,
                        guild events, and WhatsApp-linked rewards.
                    </p>
                    ...
                    {playerCount !== null && (
                        ...
                        >
                            ...
                            <span>
                                {playerCount.toLocaleString("en-US")} players in
                                the network
                            </span>
                        </div>
                    )}
                    ...
                    <div className="mt-5 flex items-center justify-between gap-4">
                        <label className="flex cursor-pointer items-center gap-2">
                            <input
                                ...
                                onChange={e =>
                                    set("rememberMe", e.target.checked)
                                }
