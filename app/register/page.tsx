...
function RegisterInner() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        setLoading(true);
        try {
            // [NEW] Cross-referenced backend-side by core/suspicion.ts as one
            // soft mod-facing signal among several — never used to block
            // registration itself, and fails soft to "unavailable" if the
            // browser can't produce one (see lib/deviceFingerprint.ts).
            ...
            <section className="relative z-10 grid w-full max-w-5xl gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-start">
                ...
                <div className="flex flex-col items-center gap-6 text-center lg:items-start lg:text-left">
                    ...
                    <p
                        ...
                        style={{ animationDelay: "0.25s" }}
                    >
                        Create your companion profile for card claims, live
                        auctions, guild events, and WhatsApp-linked rewards.
                    </p>
                    <p
                        ...
                        <div className="grid gap-2">
                            ...
                            {avail.status === "error" && (
                                <p className="text-xs text-yellow-400">
                                    Couldn&apos;t check availability — try
                                    again.
                                </p>
                            )}
